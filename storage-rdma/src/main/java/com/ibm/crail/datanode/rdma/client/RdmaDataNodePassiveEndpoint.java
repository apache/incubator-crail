...
public class RdmaDataNodePassiveEndpoint extends RdmaEndpoint implements DataNodeEndpoint {
	...
	private ConcurrentHashMap<Long, RdmaDataPassiveFuture> futureMap;
	...
	public RdmaDataNodePassiveEndpoint(RdmaDataNodePassiveGroup group, RdmaCmId id) throws IOException {
		...
		this.futureMap = new ConcurrentHashMap<Long, RdmaDataPassiveFuture>();
...
//			logger.info("flush wc");
			...
			RdmaDataPassiveFuture future = futureMap.remove(wc.getWr_id());
			if (future != null){
